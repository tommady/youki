...
## [v0.0.1](https://github.com/tommady/youki/commits/v0.0.1) - 2025-09-19
### Other Changes
...
- (auto merged) chore(deps): bump errno from 0.3.13 to 0.3.14 in the patch group by @dependabot[bot] in https://github.com/tommady/youki/pull/159
- (auto merged) chore(deps): bump the patch group with 2 updates by @dependabot[bot] in https://github.com/tommady/youki/pull/161
- (auto merged) chore(deps): bump serde from 1.0.223 to 1.0.225 in the patch group by @dependabot[bot] in https://github.com/tommady/youki/pull/162
